import type { Artist, JsonRelease, Link, Release, ReleaseGenre } from "./types";
...
export type ScoreCode = "rym" | "aoty";
...
export const release_is_approved = (release: Release | JsonRelease): boolean =>
